...
<img src="<?=$base64?>">
        ...
        <tr role="row">
            <th class="sorting_asc" tabindex="0" aria-controls="simpletable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 40px; color:rgb(77, 12, 181)" >ID</th>
        ...
        <hr>
        <tr role="row">
            <th class="sorting" tabindex="0" aria-controls="simpletable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending"style="width: 25px padding-right:10px"  >admin_id</th>
...
$type = pathinfo('images/signatures/{{$report->signature}}',PATHINFO_EXTENSION);
$data = file_get_contents('images/signatures/1681723789.jpg');
$base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);
