...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="color: #556AFF;">Add_Appointment</h4>
        </div>
        <div class="col-sm-6">
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{Route('backend.appointments.store')}}" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Doctor_Name<span class="text-danger"></span></label>
                    ...
                    <a class="btn btn-outline-primary btn-md  btn-lg" type="submit" href="/backend/appointments/create" >save and create another</a>
