    ...
    <div class="page-title">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <h4 class="mb-0" style="color: #556AFF;">Form</h4>
            </div>
            <div class="col-sm-6">
                    ...
                    <div class="card-body">
                       ...
                       @endif --}}
                        ...
                        <div class="container" style="direction:ltr; text-align:left; width: 100%; border:black 2px;">
                            <div class="row">
                                <div class="custom-form-input col-lg-4 col-md-4" style="height: 70px">
                                    <img src="{{URL::asset('assets/images/tawazun1.jpg')}}" height="40" width="40"
                                         alt="">
                                                    ...
                                                    <label for="doctor_name">{{trans('schedule_trans.Doctor_Name')}}<span class="text-danger">*</span></label>

                                                    <select name="doctor_name" class="custom-select mr-sm-2">
                                                        <option selected disabled>{{trans('doctor_trans.Choose')}}</option>
                                                        @foreach($doctors as $doctor)
                                                        <option  >{{ $doctor->full_name }}</option>
                                                        @endforeach
                                                    </select>
                                ...
                                <div class="custom-form-input col-lg-4 col-md-4" style="height: 70px">
                                                ...
                                                <label for="patient_name">{{trans('patient_trans.Patient_Name')}}<span class="text-danger">*</span></label>

                                                <select name="patient_name" class="custom-select mr-sm-2">
                        ...
                        <div style="padding-left:660px ">
                            ...
                            <a class="btn btn-outline-primary btn-md  btn-lg" type="submit" href="/backend/reports/create" >save and create another</a>
