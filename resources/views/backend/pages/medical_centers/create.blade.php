...
@section('title')
{{trans('medical_center_trans.Add_Medical_Center')}}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="color: #556AFF;">Add_Medical_Center</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{trans('medical_center_trans.Add_Medical_Center')}}</a></li>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{Route('backend.medical_centers.store')}}"  autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="address">{{trans('medical_center_trans.Address')}} <span class="text-danger"></span></label>
                    ...
                    <div style="padding-left:660px ">
                        ...
                        <a class="btn btn-outline-primary btn-md  btn-lg" type="submit" href="/backend/medical_centers/create" >save and create another</a>
