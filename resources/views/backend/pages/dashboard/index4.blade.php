        ...
        <div class="row ">
                ...
                <div class="card1">
                    <div class="card-body">
                        <div class="head  d-flex justify-content-between">
                            <h5 class="card-title">المدراء<span class="d-block">admins</span></h5>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="head  d-flex justify-content-between">
                            <h5 class="card-title">المسؤولين<span class="d-block">supervisors</span></h5>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                              </svg></div>
                        <div class="card-footer"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-binoculars-fill" viewBox="0 0 16 16">
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="head  d-flex justify-content-between">
                            <h5 class="card-title">الأطباء<span class="d-block">doctors</span></h5>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                              </svg></div>
                        <div class="card-footer"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-binoculars-fill" viewBox="0 0 16 16">
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="head  d-flex justify-content-between">
                            <h5 class="card-title">المرضى<span class="d-block">patients</span></h5>
        ...
        <div class="row ">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="head  d-flex justify-content-between">
                            <h5 class="card-title">الحجوزات<span class="d-block">appointments</span></h5>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="head  d-flex justify-content-between">
                            <h5 class="card-title">المراكز الطبية<span class="d-block">medical_centers</span></h5>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="head  d-flex justify-content-between">
                            <h5 class="card-title">المعامل<span class="d-block">labs</span></h5>
                            <i class="fas fa-hospital"></i></div>
                        <div class="card-footer"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-binoculars-fill" viewBox="0 0 16 16">
                            <path d="M4.5 1A1.5 1.5 0 0 0 3 2.5V3h4v-.5A1.5 1.5 0 0 0 5.5 1h-1zM7 4v1h2V4h4v.882a.5.5 0 0 0 .276.447l.895.447A1.5 1.5 0 0 1 15 7.118V13H9v-1.5a.5.5 0 0 1 .146-.354l.854-.853V9.5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v.793l.854.853A.5.5 0 0 1 7 11.5V13H1V7.118a1.5 1.5 0 0 1 .83-1.342l.894-.447A.5.5 0 0 0 3 4.882V4h4zM1 14v.5A1.5 1.5 0 0 0 2.5 16h3A1.5 1.5 0 0 0 7 14.5V14H1zm8 0v.5a1.5 1.5 0 0 0 1.5 1.5h3a1.5 1.5 0 0 0 1.5-1.5V14H9zm4-11H9v-.5A1.5 1.5 0 0 1 10.5 1h1A1.5 1.5 0 0 1 13 2.5V3z"/>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="head  d-flex justify-content-between">
                            <h5 class="card-title">التقارير<span class="d-block">reports</span></h5>
